...
class WindowCalculatorForm extends Frame{
    private static final long serialVersionUID = 1L;

   public WindowCalculatorForm(){
        super("계산기");
       ...
       this.setSize(300, 250);
        ...
        int x = (int)(screen.getWidth()/2 - frameSize.getWidth()/2);
        int y = (int)(screen.getHeight()/2 - frameSize.getHeight()/2);
    ...
    private void init(){
        ...
        BorderLayout blEast = new BorderLayout(5, 5);
        GridLayout gl = new GridLayout();
        GridLayout glEast = new GridLayout(4, 5, 3, 3);
        GridLayout glNorth1 = new GridLayout(5, 1, 3, 3);
        GridLayout glTop = new GridLayout(1, 3, 3, 3);
       
        MenuBar menuBar = new MenuBar();
        Menu view = new Menu("보기(V)");
        Menu edit = new Menu("편집(E)");
        Menu help = new Menu("도움말(H)");
       ...
       String btTitle[] = {"7", "8", "9", "/", "±", "4", "5", "6", "*", "%", "1", "2", "3", "-", "1/x", "0", "+/-", ".", "*", "="};
       ...
       Panel pNorth = new Panel();
        ...
        Panel pEastTop = new Panel();
        Panel pEastBottom = new Panel();
        ...
        pNorth1.setLayout(glTop);
       
        btMC.setForeground(Color.blue);
        btMR.setForeground(Color.blue);
        btMS.setForeground(Color.blue);
        btMPlus.setForeground(Color.blue);
        ...
        pEastTop.setLayout(glTop);
        pEastTop.add(backspace);
        pEastTop.add(ce);
        pEastTop.add(c);
       
        pEastBottom.setLayout(glEast);
       
        for(int i=0 ; i<4 ; i++){
            for(int j=0 ; j<5 ; j++){
                if(j == 3 || num[i][j].getLabel().equals("=")){
                    num[i][j].setForeground(Color.blue);
                }else{
                    num[i][j].setForeground(Color.blue);
                }

               pEastBottom.add(num[i][j]);
            }
        }
       
        pEast.setLayout(blEast);
        pEast.add("North", pEastTop);
        pEast.add("Center", pEastBottom);
       
        this.setLayout(bl);
        this.add("North", pNorth);
        this.add("North", pNorth1);
        this.add("Center", pEast);
    }
}

public class cal{
    public static void main(String[] arg){
        new WindowCalculatorForm();
    }
}
